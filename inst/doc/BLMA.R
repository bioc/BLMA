...
###################################################
### code chunk number 4: BLMA.Rnw:232-264
###################################################
library(BLMA)
...
###################################################
### code chunk number 5: BLMA.Rnw:279-290
###################################################
...
###################################################
### code chunk number 6: BLMA.Rnw:303-314
###################################################
set.seed(1)
t1=Sys.time()
...
###################################################
### code chunk number 7: BLMA.Rnw:324-334
###################################################
x=loadKEGGPathways()  
t1=Sys.time()
...
###################################################
### code chunk number 8: BLMA.Rnw:362-384
###################################################
...
t1=Sys.time()
Y = IntraAnalysisGene(data_GSE33223, group_GSE33223, 
...
###################################################
### code chunk number 9: BLMA.Rnw:396-418
###################################################
dataSets=c("GSE17054", "GSE57194", "GSE33223", "GSE42140")
data(list=dataSets, package="BLMA")
dataList <- list()

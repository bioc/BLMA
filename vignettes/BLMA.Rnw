...
We demonstrate this functionality using 6 acute myeloid leukemia (AML) 
datasets: GSE17054 (9 samples), GSE57194 (12 samples), GSE33223 (30 samples), 
GSE42140 (31 samples), GSE8023 (12 samples), and GSE14924\_CD4 (19 samples). 
...
ORA~\cite{Draghici:2003a,Tavazoie:1999} for the 6 datasets:
...
The running time for ORA is only 5 seconds. With a cutoff of 0.05, there are 
8 significant pathways, among which the target pathway 
\emph{Acute myeloid leukemia} is ranked on top with a FDR-corrected 
p-value $0.00088$.
...
1 minutes with 2 cores. With a cutoff of FDR=0.05, there are 4 significant 
pathways: \emph{Transcriptional misregulation in cancer}, 
\emph{Small cell lung cancer}, \emph{Acute myeloid leukemia} and 
\emph{Apoptosis}. All of them are known to be related to cancer and AML. 
The target pathway  \emph{Acute myeloid leukemia} is ranked $3^{rd}$ with a 
FDR-corrected p-value $0.018$.
...
The code for analyzing the dataset GSE14924\_CD4 is as follows:
